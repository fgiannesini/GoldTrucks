...
class Player {
    ...
    static final long COMPUTATION_TIME = 50;
...
//        System.err.println(bestSol.truckList.stream().filter(t -> t.volume > TRUCK_VOLUME).map(t -> String.valueOf(t.index)).collect(Collectors.joining(" ")));
